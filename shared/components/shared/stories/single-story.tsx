...
export const SingleStory: React.FC<Props> = ({ className, id }) => {
  ...
  return (
    <div className={className}>
      ...
      {isLoading && <div className="w-[200px] h-[250px] bg-gray-200 rounded-md animate-pulse" />}
      {!isLoading && story && <StoryPreview srcUrl={story.previewImageUrl} onDelete={onDelete} id={story.id} />}
